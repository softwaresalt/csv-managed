...
| Variable | Purpose |
|---|---|
| `{{HARNESS_MANIFEST_PATH}}` | Path to the installed harness manifest (default: `.autoharness/harness-manifest.yaml`) |
...
1. Check for the harness manifest at `{{HARNESS_MANIFEST_PATH}}`.
