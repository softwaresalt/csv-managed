...
Use the language's safe default constructs and avoid unsafe escape hatches unless the repository explicitly requires them.. Treat lint failures as actionable defects.. Use explicit error propagation and repository-standard error types..
...
directory structure (Primary tests live in tests/.) MUST be maintained. All tests MUST
...
| Documentation   | {{DOC_COMMENT_STYLE}}                                            |
...
|---|---|---|
| I. Safety-First Language | MUST | CI quality gates (`cargo clippy -- -D warnings`, `cargo build`) |
...
**Version**: 1.0.0 | **Ratified**: 2026-05-21 | **Generated by**: autoharness
