---
# Source: references/awesome-copilot/instructions/agent-safety.instructions.md
# License: MIT
...
- Export audit trails in structured format for integration with log aggregation systems
...
Generated by autoharness | Template: community/instructions/agent-safety.instructions.md.tmpl
