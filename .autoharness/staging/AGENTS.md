...
Use the language's safe default constructs and avoid unsafe escape hatches unless the repository explicitly requires them.. Treat lint failures as actionable defects..
Use explicit error propagation and repository-standard error types..
...
```text
# Gate 1 — {{QUALITY_GATE_1_NAME}}
{{QUALITY_GATE_1}}

# Gate 2 — {{QUALITY_GATE_2_NAME}}
{{QUALITY_GATE_2}}

# Gate 3 — {{QUALITY_GATE_3_NAME}}
{{QUALITY_GATE_3}}

# Gate 4 — {{QUALITY_GATE_4_NAME}}
{{QUALITY_GATE_4}}
```
