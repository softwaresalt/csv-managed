...
Produces seven documentation files in `docs/codebase` covering everything needed to work effectively on the project. Only document what is verifiable from files or terminal output — never infer or assume.
...
Create each document in `docs/codebase` in this order:
