...
Language-specific detection uses `* std::process::Command with shell=true or unsanitized arguments
* File I/O with user-controlled paths without canonicalization
* Deserialization of untrusted input (serde without validation)
...
2. Apply injection detection patterns from `* std::process::Command with shell=true or unsanitized arguments
* File I/O with user-controlled paths without canonicalization
* Deserialization of untrusted input (serde without validation)
* Environment variable injection
* Regex denial-of-service (ReDoS) patterns`
...
Score the workspace against OWASP Top 10 categories using `* std::process::Command with shell=true or unsanitized arguments
* File I/O with user-controlled paths without canonicalization
* Deserialization of untrusted input (serde without validation)
* Environment variable injection
* Regex denial-of-service (ReDoS) patterns`:
